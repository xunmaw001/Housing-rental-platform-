...
public class HetongzhongzhiController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,HetongzhongzhiEntity hetongzhongzhi, HttpServletRequest request){
        EntityWrapper<HetongzhongzhiEntity> ew = new EntityWrapper<HetongzhongzhiEntity>();
		PageUtils page = hetongzhongzhiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, hetongzhongzhi), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R save(@RequestBody HetongzhongzhiEntity hetongzhongzhi, HttpServletRequest request){
    	hetongzhongzhi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<HetongzhongzhiEntity> wrapper = new EntityWrapper<HetongzhongzhiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = hetongzhongzhiService.selectCount(wrapper);
