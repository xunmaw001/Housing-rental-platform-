		    ...
		    label="备注">
		     <template slot-scope="scope">
              ...
              <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"
                ...
                label="操作">
                <template slot-scope="scope">
                                                                <el-button v-if="isAuth('zulinhetong','合同终止') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="hetongzhongzhiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'合同终止':'' }}</el-button>
                <el-button v-if="isAuth('zulinhetong','合同终止') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="hetongzhongzhiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'合同终止':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('zulinhetong','合同终止') && contents.tableBtnIcon == 0" type="success" size="mini" @click="hetongzhongzhiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'合同终止':'' }}</el-button>
  ...
  methods: {
    ...
    contentPageStyleChange(){
      ...
      this.contents.pageEachNum = 10
            ...
            hetongzhongzhiCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
