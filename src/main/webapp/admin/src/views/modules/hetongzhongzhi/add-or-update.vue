  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="备注" prop="beizhu">
              <el-input v-model="ruleForm.beizhu" 
                placeholder="备注" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="终止时间" prop="zhongzhishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhongzhishijian" label="终止时间" prop="zhongzhishijian">
              <el-input v-model="ruleForm.zhongzhishijian" 
                placeholder="终止时间" readonly></el-input>
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="终止理由" prop="zhongzhiliyou">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="终止理由"
                  v-model="ruleForm.zhongzhiliyou" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhongzhiliyou" label="终止理由" prop="zhongzhiliyou">
                    <span>{{ruleForm.zhongzhiliyou}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhongzhishijian = true;
            continue;
	            	            ...
	            	            if(o=='zhongzhiliyou'){
            this.ruleForm.zhongzhiliyou = obj[o];
	    this.ro.zhongzhiliyou = true;
            continue;
          }
	            	            	                    }
                                                                                                                                                                                                                                                                                              }
