<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="报障编号" prop="baozhangbianhao">
            <el-input v-model="ruleForm.baozhangbianhao" 
                placeholder="报障编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baozhangbianhao" label="报障编号" prop="baozhangbianhao">
              <el-input v-model="ruleForm.baozhangbianhao" 
                placeholder="报障编号" readonly></el-input>
          </el-form-item>
        </div>
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="报障日期" prop="baozhangriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.baozhangriqi" 
                type="date"
                placeholder="报障日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baozhangriqi" label="报障日期" prop="baozhangriqi">
              <el-input v-model="ruleForm.baozhangriqi" 
                placeholder="报障日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.guzhangyuanyin" label="故障原因" prop="guzhangyuanyin">
                    <span>{{ruleForm.guzhangyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='baozhangriqi'){
            this.ruleForm.baozhangriqi = obj[o];
	    this.ro.baozhangriqi = true;
            continue;
          }
	            	            	                    }
                                                                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `baozhang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baozhangCrossAddOrUpdateFlag = false;
                  this.parent.search();
