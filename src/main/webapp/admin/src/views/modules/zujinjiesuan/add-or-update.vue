<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="结算编号" prop="jiesuanbianhao">
            <el-input v-model="ruleForm.jiesuanbianhao" 
                placeholder="结算编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiesuanbianhao" label="结算编号" prop="jiesuanbianhao">
              <el-input v-model="ruleForm.jiesuanbianhao" 
                placeholder="结算编号" readonly></el-input>
          </el-form-item>
        </div>
          ...
          <el-form-item class="input" label="详细地址" prop="xiangxidizhi">
              <el-input v-model="ruleForm.xiangxidizhi" 
                placeholder="详细地址" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="每月租金" prop="meiyuezujin">
          <el-input v-model="ruleForm.meiyuezujin" 
              placeholder="每月租金" clearable  :readonly="ro.meiyuezujin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="每月租金" prop="meiyuezujin">
              <el-input v-model="ruleForm.meiyuezujin" 
                placeholder="每月租金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="交付方式" prop="jiaofufangshi">
          <el-select v-model="ruleForm.jiaofufangshi" placeholder="请选择交付方式">
            <el-option
                v-for="(item,index) in jiaofufangshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="交付方式" prop="jiaofufangshi">
	      <el-input v-model="ruleForm.jiaofufangshi"
                placeholder="交付方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='jiesuanbianhao'){
            this.ruleForm.jiesuanbianhao = obj[o];
	    this.ro.jiesuanbianhao = true;
            continue;
          }
	    ...
	    this.ro.xiangxidizhi = true;
            continue;
	            	            ...
	            	            if(o=='meiyuezujin'){
            this.ruleForm.meiyuezujin = obj[o];
	    this.ro.meiyuezujin = true;
            continue;
          }
	            	            if(o=='xingming'){
	    ...
	    this.ro.xingming = true;
            continue;
	            	            ...
	            	            if(o=='jiaofufangshi'){
            this.ruleForm.jiaofufangshi = obj[o];
	    this.ro.jiaofufangshi = true;
            continue;
          }
	            	            if(o=='riqi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                      ...
                                                                                                                                                      this.$http({
              url: `option/zujinjiaofu/jiaofuleixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.jiaofufangshiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zujinjiesuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zujinjiesuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
