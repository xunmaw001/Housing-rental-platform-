<template>
  <div class="main-content">
		    ...
		    label="发布日期">
		     <template slot-scope="scope">
                ...
                <el-button v-if="isAuth('fangwuxinxi','查看') && contents.tableBtnIcon == 0" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                                                                <el-button v-if="isAuth('fangwuxinxi','租用') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="fangwuyudingCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'租用':'' }}</el-button>
                <el-button v-if="isAuth('fangwuxinxi','租用') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="fangwuyudingCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'租用':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('fangwuxinxi','租用') && contents.tableBtnIcon == 0" type="success" size="mini" @click="fangwuyudingCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'租用':'' }}</el-button>
                                                <el-button v-if="isAuth('fangwuxinxi','合同') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="zulinhetongCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'合同':'' }}</el-button>
                <el-button v-if="isAuth('fangwuxinxi','合同') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="zulinhetongCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'合同':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('fangwuxinxi','合同') && contents.tableBtnIcon == 0" type="success" size="mini" @click="zulinhetongCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'合同':'' }}</el-button>
                                                <el-button v-if="isAuth('fangwuxinxi','报障') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="baozhangCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'报障':'' }}</el-button>
                <el-button v-if="isAuth('fangwuxinxi','报障') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="baozhangCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'报障':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('fangwuxinxi','报障') && contents.tableBtnIcon == 0" type="success" size="mini" @click="baozhangCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'报障':'' }}</el-button>
    ...
    <add-or-update v-if="addOrUpdateFlag" :parent="this" ref="addOrUpdate"></add-or-update>
            ...
            <fangwuyuding-cross-add-or-update v-if="fangwuyudingCrossAddOrUpdateFlag" :parent="this" ref="fangwuyudingCrossaddOrUpdate"></fangwuyuding-cross-add-or-update>
        ...
        <baozhang-cross-add-or-update v-if="baozhangCrossAddOrUpdateFlag" :parent="this" ref="baozhangCrossaddOrUpdate"></baozhang-cross-add-or-update>
...
import fangwuyudingCrossAddOrUpdate from "../fangwuyuding/add-or-update";
import zulinhetongCrossAddOrUpdate from "../zulinhetong/add-or-update";
import baozhangCrossAddOrUpdate from "../baozhang/add-or-update";
export default {
  data() {
    return {
      ...
      addOrUpdateFlag:false,
                  fangwuyudingCrossAddOrUpdateFlag: false,
            zulinhetongCrossAddOrUpdateFlag: false,
            baozhangCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
            fangwuyudingCrossAddOrUpdate,
        zulinhetongCrossAddOrUpdate,
        baozhangCrossAddOrUpdate,
          },
  methods: {
    contentStyleChange() {
    ...
    contentPageStyleChange(){
      ...
      this.contents.pageEachNum = 10
            ...
            fangwuyudingCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.fangwuyudingCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','fangwuxinxi');
      this.$nextTick(() => {
        this.$refs.fangwuyudingCrossaddOrUpdate.init(row.id,type);
      });
    },
        zulinhetongCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      ...
      this.$nextTick(() => {
        ...
        baozhangCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.baozhangCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','fangwuxinxi');
      this.$nextTick(() => {
        this.$refs.baozhangCrossaddOrUpdate.init(row.id,type);
      });
    },
                    init () {
                                                                    this.$http({
